...
//user already paid for the course if yes then user dont have to again pay the money
    ...
    const options={
        ...
        currency,
        receipt:Math.random(Date.now()).toString(),//Razorpay uses the receipt field to identify and track specific payment orders.(its optional)
